...
To view a live example, **[click here](https://www.sunildutt.in/)**.
...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/1xjQFPynPsJMujQRL4nrSel8oQsQkcLba/view?usp=sharing?usp=sharing"
};

const socialMediaLinks = {
  /* Your Social Media Link */
  github: "https://github.com/sunildutt",
  linkedin: "https://www.linkedin.com/in/sunildutt/",
  gmail: "dutt447@gmail.com",
  gitlab: "https://gitlab.com/sunildutt",
  facebook: "https://www.facebook.com/sunildutt"
};
...
- Navigate to `package.json` and enter your domain name instead of `https://www.sunildutt.in/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/developerFolio`, add the same to the homepage section of `package.json`.
